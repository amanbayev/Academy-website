...
export function Button({href, children, variant = 'primary', className, type = 'button'}: ButtonProps) {
  const classes = cn(
    'inline-flex min-h-11 items-center justify-center gap-3 rounded-md px-6 text-sm font-semibold transition focus:outline-none focus:ring-2 focus:ring-academy-red focus:ring-offset-2',
